...
import Practica_1_epy_block_2_0 as epy_block_2_0  # embedded python block
import sip
import threading
...
class Practica_1(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        gr.top_block.__init__(self, "JDQG_1", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("JDQG_1")
        ...
        self._AMP_RUIDO_range = qtgui.Range(0.0005, 100, 0.01, 1, 200)
        self._AMP_RUIDO_win = qtgui.RangeWidget(self._AMP_RUIDO_range, self.set_AMP_RUIDO, "'AMP_RUIDO'", "counter_slider", float, QtCore.Qt.Horizontal)
        ...
        self.qtgui_number_sink_4_0 = qtgui.number_sink(
            gr.sizeof_float,
            0,
        ...
        self.qtgui_number_sink_4_0.set_update_time(0.10)
        self.qtgui_number_sink_4_0.set_title('Desviacion Estandar FUENTE')
        ...
        for i in range(1):
            self.qtgui_number_sink_4_0.set_min(i, -1)
            self.qtgui_number_sink_4_0.set_max(i, 1)
            self.qtgui_number_sink_4_0.set_color(i, colors[i][0], colors[i][1])
            if len(labels[i]) == 0:
                self.qtgui_number_sink_4_0.set_label(i, "Data {0}".format(i))
            else:
                self.qtgui_number_sink_4_0.set_label(i, labels[i])
            self.qtgui_number_sink_4_0.set_unit(i, units[i])
            self.qtgui_number_sink_4_0.set_factor(i, factor[i])

        self.qtgui_number_sink_4_0.enable_autoscale(False)
        self._qtgui_number_sink_4_0_win = sip.wrapinstance(self.qtgui_number_sink_4_0.qwidget(), Qt.QWidget)
        self.top_layout.addWidget(self._qtgui_number_sink_4_0_win)
        ...
        self.qtgui_number_sink_3_0.set_title('Potencia Promedio FUENTE')
        ...
        self.qtgui_number_sink_2_0.set_title('RMS FUENTE')
        ...
        for i in range(1):
            self.qtgui_number_sink_2_0.set_min(i, -1)
            self.qtgui_number_sink_2_0.set_max(i, 1)
        ...
        self.qtgui_number_sink_1_0.set_title('Media Cuadratica FUENTE')
        ...
        self.qtgui_number_sink_0_0.set_title('Media FUENTE')
        ...
        self.connect((self.analog_sig_source_x_1, 0), (self.epy_block_2_0, 0))
        ...
        self.connect((self.epy_block_2_0, 0), (self.qtgui_number_sink_0_0, 0))
        self.connect((self.epy_block_2_0, 1), (self.qtgui_number_sink_1_0, 0))
        self.connect((self.epy_block_2_0, 2), (self.qtgui_number_sink_2_0, 0))
        self.connect((self.epy_block_2_0, 3), (self.qtgui_number_sink_3_0, 0))
        self.connect((self.epy_block_2_0, 4), (self.qtgui_number_sink_4_0, 0))
